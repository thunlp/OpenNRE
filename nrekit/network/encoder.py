...
def pcnn(x, pos1, pos2, hidden_size=230, kernel_size=3, stride_size=1, activation=tf.nn.relu, var_scope=None):
...
def rnn(x, length, hidden_size=230, cell_name='lstm', var_scope=None):
...
def birnn(x, length, hidden_size=230, cell_name='lstm', var_scope=None):
