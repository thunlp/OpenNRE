...
parser.add_argument('--dataset', default='none', choices=['none', 'semeval', 'wiki80', 'tacred', 'nyt10', 'fewrel'],
...
if args.pooler == 'entity':
    sentence_encoder = opennre.encoder.BERT2EntityEncoder(
    ...
    sentence_encoder = opennre.encoder.BERT2Encoder(
        max_length=args.max_length,
        pretrain_path=args.pretrain_path,
        mask_entity=args.mask_entity
    )
...
# Define the model
model = opennre.model.SoftmaxENN(sentence_encoder, len(rel2id), rel2id)

# Define the whole training framework
framework = opennre.framework.SentenceEntityRE(
